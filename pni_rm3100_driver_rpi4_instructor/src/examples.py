...
"""
def execute_continuous_measurements_with_assigned_settings(moving_avg_window = 20, dt_seconds = 0.1):
...
execute_continuous_measurements_with_default_config()
    ...
    These functions take in a "pni_rm3100_device" that has been configued to the user's preferences
"""
def execute_continuous_measurements_with_default_config(moving_avg_window = 20, dt_seconds = 0.1):
    # Instantiate Objects
    pni_rm3100_device = pni_rm3100.PniRm3100()
